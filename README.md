...
* [gno monorepo](https://github.com/gnolang/gno) ⭐ 1,082 | 🐛 562 | 🌐 Go | 📅 2026-09-13 - The official core repo of the project, containing the core libraries, tools, and example Gno code.
* [Plan](https://github.com/gnolang/gno/blob/master/PLAN.md) ⭐ 1,082 | 🐛 562 | 🌐 Go | 📅 2026-09-13 - The foundational plan for gno.land.
* [Philosophy](https://github.com/gnolang/gno/blob/master/PHILOSOPHY.md) ⭐ 1,082 | 🐛 562 | 🌐 Go | 📅 2026-09-13 - The fundamental philosophies of gno.land.
...
* [meme.land](https://github.com/gnoverse/memeland) ⭐ 4 | 🐛 7 | 🌐 TypeScript | 📅 2024-10-10 - An image sharing application built using Gno, React and Vue.
...
* [Gnoswap](https://github.com/gnoswap-labs/gnoswap) ⭐ 17 | 🐛 16 | 🌐 Gno | 📅 2026-09-11 - The first DEX built on gno.land (currently in beta).
* [dSocial](https://github.com/gnoverse/dsocial) ⭐ 9 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-27 - Experimental social apps, tools, and dApps.
* [Gnomputer](https://github.com/moul/gnomputer) ⭐ 1 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-10 - A windowed web workstation for browsing realms, source, and live chain activity.
...
* [gnodev](https://github.com/gnolang/gno/tree/master/contribs/gnodev) ⭐ 1,082 | 🐛 562 | 🌐 Go | 📅 2026-09-13 - Your Gno development companion, used for local Gno development.
* [gnobro](https://github.com/gnolang/gno/tree/master/contribs/gnobro) ⭐ 1,082 | 🐛 562 | 🌐 Go | 📅 2026-09-13 - A terminal UI for browsing and exploring Gno realms, with real-time gnodev integration via WebSocket.
...
* [tx-indexer](https://github.com/gnolang/tx-indexer) ⭐ 11 | 🐛 12 | 🌐 Go | 📅 2026-08-27 - A TM2 (Tendermint2) chain indexer with GraphQL support.
...
* [gno-mcp](https://github.com/gnoverse/gno-mcp) ⭐ 3 | 🐛 10 | 🌐 Go | 📅 2026-09-07 - An MCP server and agent skill connecting realms to AI coding assistants like Claude, Cursor, and Gemini CLI.
...
* [gno-contracts](https://github.com/moul/gno-contracts) ⭐ 1 | 🐛 3 | 🌐 Go | 📅 2026-09-12 - A collection of 50+ versioned, self-contained gno.land packages and realms by moul, tested against gno master.
...
* [gnoclient](https://github.com/gnolang/gno/tree/master/gno.land/pkg/gnoclient) ⭐ 1,082 | 🐛 562 | 🌐 Go | 📅 2026-09-13 - A Gno-Go package, allowing you to connect to gno.land chains via Go programs at will.
* [tm2-js-client](https://github.com/gnolang/tm2-js-client) ⭐ 12 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-13 - A TM2 JavaScript client library.
...
* [gnolang/blog](https://github.com/gnolang/blog/tree/main/cmd/gnoblog-cli) ⭐ 9 | 🐛 19 | 🌐 Go | 📅 2026-09-01 - `r/gnoland/blog` client, or how to create custom `gnokey` clients, using the [gnoclient](https://github.com/gnolang/gno/tree/master/gno.land/pkg/gnoclient) ⭐ 1,082 | 🐛 562 | 🌐 Go | 📅 2026-09-13 package.
* [gno-js-client](https://github.com/gnolang/gno-js-client) ⭐ 2 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-13 - A Gno JavaScript client library, built upon `tm2-js` with additional Gno-specific functionality.
...
* [Workshops & Talks](https://github.com/gnolang/workshops) ⭐ 13 | 🐛 13 | 🌐 TypeScript | 📅 2025-07-17 - Slides, videos, and materials to gno.land workshops.
...
[contribution guidelines](https://github.com/gnoverse/awesome-gno/blob/main/CONTRIBUTING.md) ⭐ 59 | 🐛 23 | 📅 2026-08-24 first.

We will keep some pull requests open if we're not sure whether those libraries
are awesome. You could [vote for them](https://github.com/gnoverse/awesome-gno/pulls) ⭐ 59 | 🐛 23 | 📅 2026-08-24 by adding :+1: to them.

## Archive

*Older, outdated, or archived items.*

* [Keplr Integration](https://github.com/gnolang/gno/pull/154) ⭐ 1,082 | 🐛 562 | 🌐 Go | 📅 2026-09-13 - WIP Integration with the Keplr browser extension.
...
* [tx-exports](https://github.com/gnolang/tx-exports) ⭐ 1 | 🐛 7 | 🌐 Go | 📅 2026-09-13 - Archived transaction data from past and present gno.land networks (gnoland1, staging, topaz, and the test1-test13 testnets).
